...
FFT_Processor_nayuki::FFT_Processor_nayuki(const int32_t N): _2N(2*N),N(N),Ns2(N/2),fpga_fft(N) {
...
void FFT_Processor_nayuki::execute_reverse_int(cplx* res, const int32_t* a) {
    ...
    fpga_fft.fft_transform_reverse(tables_reverse,real_inout,imag_inout);
